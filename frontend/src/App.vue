...
<template>
  ...
  >
    <OzonCollectView
      v-if="store.activeModule.value === 'ozon-collect' || store.activeModule.value === 'shop-pipeline'"
      :initial-panel="store.activeModule.value === 'shop-pipeline' ? 'pipeline' : 'collect'"
    />
